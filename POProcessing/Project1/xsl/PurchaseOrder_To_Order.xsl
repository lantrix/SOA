...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.3.0(build 100415.2045.2557) AT [TUE JUN 07 16:15:44 EST 2011]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://xmlns.oracle.com/pcbpel/adapter/file/POProcessing/Project1/WriteApprovalResults"
                ...
                exclude-result-prefixes="xsi xsl inp1 xsd wsdl tns ns0 plt bpws xp20 mhdr bpel2 oraext dvm hwf med ids bpm xdk xref ora socket ldap">
  <xsl:template match="/">
    <inp1:Order>
      <inp1:customerId>
